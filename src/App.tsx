...
function App() {
  ...
  return (
    <div className=" flex h-full min-h-screen flex-wrap items-center justify-center gap-20 bg-[#14172B] py-20">
      {coins.map((coin) => (
        <div
          key={coin.id}
        ...
        >
          ...
          <span className="text-xs text-[#737BAE]">Bitcoin (BTC)</span>
          <div className="">
            <span className="element-shadow relative mx-5 flex justify-center rounded-3xl border border-transparent bg-[#14172B] py-2 text-[#ECF0FF]">
              ...
              <span
                className={`absolute top-1/2 right-3 -translate-y-1/2 text-xs ${
                  coin.price.change < 0 ? "text-[#FF4D4D]" : "text-[#00FFA3]"
                } `}
              >
